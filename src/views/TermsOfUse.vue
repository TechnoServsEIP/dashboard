    ...
    <div class="card bg-secondary shadow border-0">
      <div class="card-body px-lg-5 pt-lg-5">
        <div class="text-muted mb-4">
          ...
          <p>
            The technoservs website located at
            https://technoservs.ichbinkour.eu/ is a copyrighted work belonging
            to TechnoServs. Certain features of the Site may be subject to
          ...
          <p>
            ...
            technoservs uses ‘cookies’. These cookies are used to store
          ...
          <p>
            ...
            Notice to the Company should be sent to: 24, rue Pasteur 94270 LE
            KREMLIN BICETRE. After the Notice is received, you and the Company
